  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Dating Applications - Ignite new friendships in a four-way video conversation. Discover, Connect, Engage, and Enjoy."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1611679782010-5ac7ff596d9a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx2aWRlbyUyQmNoYXR8ZW58MHx8fHwxNjk4MjExMzk0fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Dating Applications - Ignite new friendships in a four-way video conversation. Discover, Connect, Engage, and Enjoy.`}
            </Text>
            <Box
